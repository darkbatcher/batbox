...
set FOOTER=/F doc_gen/footer_fr.html
set TITLE=/T Le /T Projet /T Dos9 /T :: 
set META=/M doc_gen/meta.html
...
For /r "man\fr" %%A in (*.*) do (
   ...
   tea "%%~A" "!htmlPath!" /E:UTF-8 /O:HTML /F "%FOOTER% %TITLE% %META%" > NUL
...
SET TEA_TEXT_LINKS=
set FOOTER=/F doc_gen/footer_en.html
set TITLE=/T The /T Dos9 /T Project /T :: 
